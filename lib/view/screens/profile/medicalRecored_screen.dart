                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        smallSpace,
                        Text("red blood cell : 4.10 million cells/mcL",style: mediumNormalGrey,),
                        smallSpace,
                        Text("hemogoblin : 142 grams/L",style: mediumNormalGrey),
                        smallSpace,
                        Text("hematocrit : 33.6%",style: mediumNormalGrey),
                        smallSpace,
                        Text("white blood cells : 3.850 cells/mcL",style: mediumNormalGrey),
                        smallSpace,
                      ],
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        smallSpace,
                        Text("red blood cell : 3.90 million cells/mcL",style: mediumNormalGrey),
                        smallSpace,
                        Text("hemogoblin : 122 grams/L",style: mediumNormalGrey),
                        smallSpace,
                        Text("hematocrit : 47.7%",style: mediumNormalGrey),
                        smallSpace,
                        Text("white blood cells : 4.300 cells/mcL",style: mediumNormalGrey),
                        smallSpace,
                      ],
                    ),
                  ],
